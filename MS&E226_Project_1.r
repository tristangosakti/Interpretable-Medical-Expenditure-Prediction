...
data = read.delim('./MedExp.csv', sep=',')
...
print(curr_rmse) # 854.1291
print(sqrt(min(cv_fm_ridge$cvm))) # 861.4073
...
print(sqrt(min(cv_fm_lasso$cvm))) # 858.3144
